 ...
 */
function geofill_civicrm_managed(&$entities) {
  _geofill_civix_civicrm_managed($entities);
}
 ...
 */
function geofill_civicrm_caseTypes(&$caseTypes) {
  _geofill_civix_civicrm_caseTypes($caseTypes);
}
 ...
 * @link http://wiki.civicrm.org/confluence/display/CRMDOC/hook_civicrm_caseTypes
 */
function geofill_civicrm_angularModules(&$angularModules) {
_geofill_civix_civicrm_angularModules($angularModules);
}
 ...
 *
function geofill_civicrm_preProcess($formName, &$form) {
